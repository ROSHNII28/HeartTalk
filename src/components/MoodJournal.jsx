  ...
  return (
    <div className="min-h-screen bg-[#FFF7FB] p-6">
      <style>{`
        ...
        .calm-steps-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; }

        @media (max-width: 768px) {
          .journal-layout { grid-template-columns: 1fr; gap: 16px; }
          .entries-list { height: 200px; }
          .editor-grid { grid-template-columns: 1fr; gap: 16px; }
          .calm-steps-grid { grid-template-columns: 1fr; gap: 8px; }
