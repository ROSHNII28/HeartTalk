  ...
  transform: translateY(-1px);
    ...
    @media (max-width: 768px) {
      ...
      .nav-links {
        ...
        padding: 24px;
        box-shadow: 0 10px 20px rgba(184, 180, 227, 0.1);
        gap: 20px;
        align-items: center;
        border-top: 1px solid rgba(106, 62, 161, 0.05);
      }
        ...
        <nav>
          <div className="container">
            <div className="nav-content">
              <div className="logo" onClick={() => { navigate("/home"); setMobileMenuOpen(false); }} style={{ cursor: "pointer" }}>HeartTalk</div>
              <div className={`nav-links ${mobileMenuOpen ? 'open' : ''}`}>
                <a href="#about" onClick={() => setMobileMenuOpen(false)}>About</a>
                <a href="#features" onClick={() => setMobileMenuOpen(false)}>Features</a>
                <a href="#wellness" onClick={() => setMobileMenuOpen(false)}>Wellness</a>
                <button className="profile-btn" onClick={() => { navigate("/Profile"); setMobileMenuOpen(false); }}>
                  Profile
                </button>
              </div>
