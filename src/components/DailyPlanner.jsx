...
const plannerStyles = {
  ...
  daysRow: { display: "flex", justifyContent: "center", gap: "15px", fontWeight: "600", marginTop: "15px", flexWrap: "wrap" },
  dateRow: { textAlign: "right", marginTop: "10px", display: "flex", justifyContent: "flex-end", alignItems: "center", flexWrap: "wrap", gap: "5px" },
  ...
  mainContent: { display: "flex", marginTop: "25px", gap: "20px", flexWrap: "wrap" },
  todoBox: { flex: "1 1 300px", background: "#ffe4ef", borderRadius: "15px", padding: "20px" },
  ...
  rightColumn: { flex: "1.2 1 320px", display: "flex", flexDirection: "column", gap: "20px" },
  sectionBox: { background: "#f9dbe8", minHeight: "150px", borderRadius: "15px", padding: "15px" },
};
...
const manifestStyles = {
  ...
  box: { flex: "1 1 250px", background: "#E8C8EB", padding: "15px", borderRadius: "15px", boxShadow: "0 0 10px rgba(0,0,0,0.1)" },
  boxLarge: { flex: "1 1 250px", background: "#F7D1E4", padding: "15px", borderRadius: "15px", minHeight: "200px" },
...
const selfcareStyles = {
  page: { background: "#E4C1C6", padding: "30px 20px", borderRadius: "25px", boxShadow: "0 0 15px rgba(0,0,0,0.1)", color: "#4a3a3a" },
  title: { textAlign: "center", fontSize: "34px", fontWeight: "600", marginBottom: "15px" },
  topRow: { display: "flex", justifyContent: "space-between", marginBottom: "20px", alignItems: "center", flexWrap: "wrap", gap: "12px" },
  ...
  daysRow: { display: "flex", gap: "12px", fontWeight: "600", flexWrap: "wrap" },
  sectionTitle: { marginTop: "10px", fontWeight: "600", fontSize: "20px" },
  checklistGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", marginTop: "10px", gap: "10px 20px" },
  ...
  moodRow: { display: "flex", gap: "15px", marginTop: "10px", flexWrap: "wrap" },
